class Permission
  ...
  private
    ...
    def platform_admin_permissions
      ...
      return true if controller == 'admin/stores/users' && action.in?(%w(index show new create edit update destroy))
      ...
      return true if controller == 'orders' && action.in?(%w(index show edit update))
    end

    def store_admin_permissions
      return true if controller == "sessions" && action.in?(%w(new create destroy))
      return true if controller == 'carts' && action.in?(%w(index new create update destroy))
      ...
      return true if controller == 'orders' && action.in?(%w(index show new create edit update destroy))
      return true if controller == 'admin/stores/items' && action.in?(%w(index show new create edit update destroy))
      return true if controller == 'admin/stores/orders' && action.in?(%w(index show new create edit update destroy))
